...
! defined( 'WOOSW_VERSION' ) && define( 'WOOSW_VERSION', '2.9.0' );
                            ...
                            <div class="woosw-content">
                                <div class="woosw-content-top">
									...
									<?php if ( get_option( 'woosw_empty_button', 'no' ) === 'yes' ) {
										echo '<span class="woosw-empty">' . self::localization( 'empty_button', esc_html__( 'Remove all', 'woo-smart-wishlist' ) ) . '</span>';
									} ?>
                                ...
                                <div class="woosw-content-bot">
                                    <div class="woosw-content-bot-inner">
                                        <a class="woosw-page" href="<?php echo self::get_url( self::get_key() ); ?>">
