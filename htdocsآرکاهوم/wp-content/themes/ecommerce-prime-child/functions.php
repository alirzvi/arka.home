...
add_action( 'after_setup_theme', 'ecommerceprime_theme_setup', 10 );
function ecommerceprime_theme_setup() {
add_action('wp_enqueue_scripts', 'navid_rtl_css');	
}


function ecommerceprimechild_translation_setup() {
	load_child_theme_textdomain( 'ecommerce-prime', get_stylesheet_directory() . '/languages');
}
add_action( 'after_setup_theme', 'ecommerceprimechild_translation_setup' );
