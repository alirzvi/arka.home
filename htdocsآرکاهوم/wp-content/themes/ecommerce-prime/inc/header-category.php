...
if (!function_exists('ecommerce_prime_bottom_header_product_category')):

    // Header product category.
    function ecommerce_prime_bottom_header_product_category(){
                ...
                <div class="twp-dropdown-category">
                    ...
                    <div class="twp-dropdown-title">
                        ...
                        <a href="javascript:void(0)" id="hamburger-one" class="twp-dropdown-label">
                            <?php if ($header_product_category_title) {
                                echo esc_html($header_product_category_title);
                            } ?>
                            <svg class="dropdown-arrow-icon" xmlns="http://www.w3.org/2000/svg" width="32"
                                                ...
                                                <div class="twp-submenu-group">
                                                    <?php if ($categories) {
                                                        foreach ($cat_array as $cat_slug) {
                                                            ...
                                                            <div class="twp-submenu-details <?php if ($cat_array) {
                                                                echo 'twp-has-subcat';
                                                            } ?>">
                                                                <div class="twp-submenu-title">
                                                                    <a href="">
                                                                        <?php echo esc_html($term_child->name); ?>
                                                                        <span><?php echo absint($term_child->count) . esc_html__(' Items', 'ecommerce-prime'); ?></span>
                                                                    </a>
                                                                </div>
