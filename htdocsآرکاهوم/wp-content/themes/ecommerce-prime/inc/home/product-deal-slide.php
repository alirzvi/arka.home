...
if ( !function_exists( 'ecommerce_prime_product_deal_slide' ) ):

    // Header Featured Post.
    function ecommerce_prime_product_deal_slide( $ecommerce_prime_home_section,$repeat_times ){
        ...
        $section_title_2 = isset( $ecommerce_prime_home_section->section_title_2 ) ? $ecommerce_prime_home_section->section_title_2 : '' ;
        ...
        $sorting_type  = isset( $ecommerce_prime_home_section->sorting_type ) ? $ecommerce_prime_home_section->sorting_type : '' ;
        $enable_review_comment  = isset( $ecommerce_prime_home_section->enable_review_comment ) ? $ecommerce_prime_home_section->enable_review_comment : '' ;
        ...
        <div class="twp-blocks twp-deals-block">
            <div class="wrapper">
                                                ...
                                                <div class="twp-deals-details">
                                                    <div class="twp-product-content">
                                                        ...
                                                        <div class="twp-item-status">
                                                                <?php esc_html_e('Status:','ecommerce-prime'); ?>
                                                                <span>
                                                                    ...
                                                                    if( $stock_status == 'outofstock' ){
                                                                        ...
                                                                        esc_html_e('Out of stock','ecommerce-prime');

                                                                    }elseif( $stock_status == 'onbackorder' ){

                                                                        esc_html_e('On backorder','ecommerce-prime');

                                                                    }else{

                                                                        esc_html_e('In Stock','ecommerce-prime');
                                                                       ...
                                                                       <div class="wrapper-row wrapper-row-small">
                                                                            ...
                                                                            <div class="column column-8">
                                                                                <div class="comments-content">
                                                                                    ...
                                                                                    <span class="twp-hasgiven"><?php echo esc_html__('has reviewed','ecommerce-prime'); ?></span>

		                                                                            <div class="star-rating" role="img" aria-label="<?php echo esc_attr__('Rated ','ecommerce-prime').absint( $rating ). esc_attr__(' out of 5','ecommerce-prime'); ?>">

		                                                                                <span style="width:<?php echo absint($rating_width); ?>%">
		                                                                                    <?php echo esc_html__('Rated ','ecommerce-prime'); ?>

		                                                                                    <strong class="rating"><?php echo absint( $rating ); ?> </strong>

		                                                                                    <?php echo esc_html__(' out of 5','ecommerce-prime'); ?>
