...
if (!function_exists('ecommerce_prime_slide_banner')):

    // Recommended Posts Functions.
    function ecommerce_prime_slide_banner($ecommerce_prime_home_section,$repeat_times)
    {

        $slide_banner_post_category = isset( $ecommerce_prime_home_section->post_category ) ? $ecommerce_prime_home_section->post_category : '' ;
        $slider_banner_type = isset( $ecommerce_prime_home_section->slider_banner_type ) ? $ecommerce_prime_home_section->slider_banner_type : '' ;
                ...
                <div loop-count="<?php echo absint($repeat_times); ?>" class="main-slider"
                    ...
                    if ($slider_banner_type == 'page') {
                        ...
                        for ($x = 1; $x <= 3; $x++) {
                            ...
                            $banner_slide_page = absint($ecommerce_prime_home_section->$page_id_1);

                            $link_1 = 'banner_slide_link_' . $x;
                            $banner_slide_link = esc_url($ecommerce_prime_home_section->$link_1);
                            if( empty( $banner_slide_link ) ){
                                $banner_slide_link = esc_url( get_the_permalink() );
                            }

                            $button_label_1 = 'banner_slide_buy_new_button_label_' . $x;
                            $banner_slide_button_label = esc_html($ecommerce_prime_home_section->$button_label_1);
                        ...
                        $product_1 = $ecommerce_prime_home_section->banner_slide_product_1;
                        $product_2 = $ecommerce_prime_home_section->banner_slide_product_2;
                        $product_3 = $ecommerce_prime_home_section->banner_slide_product_3;
                        ...
                        if ($slide_banner_post_query->have_posts()) {
                            ...
                            while ($slide_banner_post_query->have_posts()) {
                                ...
                                $banner_slide_link_2 = esc_url($ecommerce_prime_home_section->$link_2);
                                ...
                                $banner_slide_button_label = esc_html($ecommerce_prime_home_section->$button_label_2); ?>
