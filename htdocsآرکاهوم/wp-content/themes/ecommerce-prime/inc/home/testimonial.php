...
if (!function_exists('ecommerce_prime_testimonial')):

    // Testimonial Function
    function ecommerce_prime_testimonial($ecommerce_prime_home_section)
    {
        $testimonial_title = isset( $ecommerce_prime_home_section->section_title ) ? $ecommerce_prime_home_section->section_title : '' ;
        $testimonial_type = isset( $ecommerce_prime_home_section->testimonial_content_type ) ? $ecommerce_prime_home_section->testimonial_content_type : '' ;
        $testimonial_layout = isset( $ecommerce_prime_home_section->testimonial_layout ) ? $ecommerce_prime_home_section->testimonial_layout : '' ;
        $post_category = isset( $ecommerce_prime_home_section->post_category ) ? $ecommerce_prime_home_section->post_category : '' ;
        ...
        ?>
        <div class="twp-blocks twp-testmonials">
            <div class="wrapper">
                                    ...
                                    <div class="testimonials-items">
                                        <div class="testimonials-caption">
                                            ...
                                            <?php if(  $testimonial_layout == 'slide' && $image_url ){ ?>
                                                <div class="twp-author-avatar bg-image">
                                                    <img src="<?php echo esc_url( $image_url ); ?>" alt="<?php esc_attr_e('Reviewer Avatar','ecommerce-prime'); ?>" title="<?php esc_attr_e('Reviewer Avatar','ecommerce-prime'); ?>" >
                                                </div>
                                            <?php } ?>
                                            ...
                                            <?php if ($rating) { ?>
                                                <div class="twp-item-ratings">
                                                    ...
                                                    <div class="star-rating" role="img" aria-label="<?php esc_attr_e('Rated', 'ecommerce-prime'); ?> <?php echo absint($rating); ?> <?php esc_html_e('out of 5', 'ecommerce-prime'); ?>">
                                                        
                                                        <span style="width:<?php echo absint($percent); ?>%">

                                                            <?php esc_html_e('Rated', 'ecommerce-prime'); ?>
                                                            <strong class="rating"><?php echo absint($rating); ?> </strong>
                                                            <?php esc_html_e('out of 5', 'ecommerce-prime'); ?>
                                        ...
                                        <div class="testimonials-author">
                                            ...
                                            <div class="twp-author-desc">
                                                ...
                                                <?php esc_html_e('on', 'ecommerce-prime'); ?>
