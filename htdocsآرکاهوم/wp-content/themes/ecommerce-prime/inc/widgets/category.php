...
if ( !function_exists('ecommerce_prime_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function ecommerce_prime_category_widgets(){
        // Recent Post widget.
        register_widget('Ecommerce_Prime_Sidebar_Category_Widget');

    }

endif;
add_action('widgets_init', 'ecommerce_prime_category_widgets');

// Recent Post widget
if ( !class_exists('Ecommerce_Prime_Sidebar_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class Ecommerce_Prime_Sidebar_Category_Widget extends Ecommerce_Prime_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'ecommerce_prime_category_widget',
                'description' => esc_html__('Displays categories and posts.', 'ecommerce-prime'),
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Categories:', 'ecommerce-prime'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
                ...
                'enable_cat_desc' => array(
                    'label' => esc_html__('Enable Category Description:', 'ecommerce-prime'),
                    'type' => 'checkbox',
                    'default' => true,
                ),
                'latest_title' => array(
                    'label' => esc_html__('Latest Text Label:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default' => esc_html__('Latest :', 'ecommerce-prime'),
                ),
            );

            parent::__construct('ecommerce-prime-category-layout', esc_html__('EP: Category Widget', 'ecommerce-prime'), $opts, array(), $fields);
        }
