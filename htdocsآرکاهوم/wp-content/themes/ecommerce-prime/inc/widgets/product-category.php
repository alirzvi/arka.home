...
if ( !function_exists('ecommerce_prime_producta_category_widgets') ) :
     ...
     * @since 1.0.0
     */
    function ecommerce_prime_producta_category_widgets(){
        // Recent Post widget.
        register_widget('Ecommerce_Prime_Sidebar_Product_Category_Widget');

    }

endif;
add_action('widgets_init', 'ecommerce_prime_producta_category_widgets');

// Recent Post widget
if ( !class_exists('Ecommerce_Prime_Sidebar_Product_Category_Widget') ) :
     ...
     * @since 1.0.0
     */
    class Ecommerce_Prime_Sidebar_Product_Category_Widget extends Ecommerce_Prime_Widget_Base
    {
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'top_category' => array(
                    'label' => esc_html__('Top Product Categories:', 'ecommerce-prime'),
                    'type' => 'number',
                    'default' => 5,
                    'css' => 'max-width:60px;',
                    'min' => 1,
            ...
            parent::__construct('ecommerce-prime-product-category-layout', esc_html__('EP: Product Category Widget', 'ecommerce-prime'), $opts, array(), $fields);
        }
