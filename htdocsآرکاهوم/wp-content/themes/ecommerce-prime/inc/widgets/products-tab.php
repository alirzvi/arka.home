...
if ( !function_exists('ecommerce_prime_tab_product_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function ecommerce_prime_tab_product_widgets(){
        // Tab Post widget.
        register_widget('Ecommerce_Prime_Tab_Product_Widget');

    }
endif;
add_action('widgets_init', 'ecommerce_prime_tab_product_widgets');

/* Tabed widget */
if ( !class_exists('Ecommerce_Prime_Tab_Product_Widget') ):
     ...
     * @since 1.0.0
     */
    class Ecommerce_Prime_Tab_Product_Widget extends Ecommerce_Prime_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'ecommerce_prime_widget_product_tabbed',
                'description' => esc_html__('Product Tabbed widget.', 'ecommerce-prime'),
            );
            $fields = array(
                'enable_discription' => array(
                    'label'             => esc_html__('Enable Description:', 'ecommerce-prime'),
                    'type'              => 'checkbox',
                    'default'           => true,
                ),
                'select_image_size' => array(
                    'label' => esc_html__('Select Image Size Featured Post:', 'ecommerce-prime'),
                    'type' => 'select',
                    'default' => 'medium',
                    'options' => array(
                        'thumbnail' => esc_html__('Thumbnail', 'ecommerce-prime'),
                        'medium' => esc_html__( 'Medium', 'ecommerce-prime' ),
                        'large' => esc_html__( 'Large', 'ecommerce-prime' ),
                        'full' => esc_html__( 'Full', 'ecommerce-prime' ),
                        ),
                    
                ),
                'excerpt_length' => array(
                    'label'         => esc_html__('Excerpt Length:', 'ecommerce-prime'),
                    'description'   => esc_html__('Number of words', 'ecommerce-prime'),
                    'default'       => 10,
                    'css'           => 'max-width:60px;',
                    'min'           => 0,
                    'max'           => 200,
                ...
                'popular_heading' => array(
                    'label'          => esc_html__('New Arrivals', 'ecommerce-prime'),
                    'type'           => 'heading',
                ),
                'new_arrival_title' => array(
                    'label' => esc_html__('New Arrivals Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('New Arrivals', 'ecommerce-prime'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Products:', 'ecommerce-prime'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Best Sellers', 'ecommerce-prime'),
                    'type'          => 'heading',
                ),
                'best_saller_title' => array(
                    'label' => esc_html__('Best Sellers Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Best Sellers', 'ecommerce-prime'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Products:', 'ecommerce-prime'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Best Deals', 'ecommerce-prime'),
                    'type'            => 'heading',
                ),
                'best_deals_title' => array(
                    'label' => esc_html__('Best Deals Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Best Deals', 'ecommerce-prime'),
                ),
            ...
            parent::__construct( 'ecommerce-prime-product-tabbed', esc_html__( 'EP: Tab Products Widget', 'ecommerce-prime' ), $opts, array(), $fields );
        ...
        function widget( $args, $instance ) {
            ...
            $new_arrival_title = isset( $params['new_arrival_title'] ) ? $params['new_arrival_title'] : '';
            $best_saller_title = isset( $params['best_saller_title'] ) ? $params['best_saller_title'] : '';
            $best_deals_title = isset( $params['best_deals_title'] ) ? $params['best_deals_title'] : '';
                    ...
                    <ul class="twp-nav-tabs" >
                        <li id="tab-new-arrivals-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-new-arrivals-<?php echo esc_attr( $args['widget_id'] ); ?> active">
                            <a href="javascript:void(0)">
                                ...
                                <?php echo esc_html( $new_arrival_title );?>
                            </a>
                        </li>
                        <li id="tab-best-sellers-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-best-sellers-<?php echo esc_attr( $args['widget_id'] ); ?>">
                            <a href="javascript:void(0)">
                                ...
                                <?php echo esc_html( $best_saller_title );?>
                            </a>
                        </li>
                        <li id="tab-best-deals-<?php echo esc_attr( $args['widget_id'] ); ?>" class="tab tab-best-deals-<?php echo esc_attr( $args['widget_id'] ); ?>">
                            <a href="javascript:void(0)">
                                ...
                                <?php echo esc_html( $best_deals_title );?>
                            </a>
                        </li>
                    </ul>
                </div>
