...
if ( !function_exists('ecommerce_prime_tab_posts_widgets') ) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function ecommerce_prime_tab_posts_widgets(){
        // Tab Post widget.
        register_widget('Ecommerce_Prime_Tab_Posts_Widget');

    }
endif;
add_action('widgets_init', 'ecommerce_prime_tab_posts_widgets');

/* Tabed widget */
if ( !class_exists('Ecommerce_Prime_Tab_Posts_Widget') ):
     ...
     * @since 1.0.0
     */
    class Ecommerce_Prime_Tab_Posts_Widget extends Ecommerce_Prime_Widget_Base {
        ...
        function __construct() {
            ...
            $opts = array(
                'classname'   => 'ecommerce_prime_widget_tabbed',
                'description' => esc_html__('Tabbed widget.', 'ecommerce-prime'),
            );
            $fields = array(
                'popular_heading' => array(
                    'label'          => esc_html__('Popular', 'ecommerce-prime'),
                    'type'           => 'heading',
                ),
                'popular_title' => array(
                    'label' => esc_html__('Popular Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Popular', 'ecommerce-prime'),
                ),
                'popular_number' => array(
                    'label'         => esc_html__('No. of Posts:', 'ecommerce-prime'),
                    'type'          => 'number',
                    'css'           => 'max-width:60px;',
                    'default'       => 5,
                    'min'           => 1,
                ...
                'recent_heading' => array(
                    'label'         => esc_html__('Recent', 'ecommerce-prime'),
                    'type'          => 'heading',
                ),
                'recent_title' => array(
                    'label' => esc_html__('Recent Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Recent', 'ecommerce-prime'),
                ),
                'recent_number' => array(
                    'label'        => esc_html__('No. of Posts:', 'ecommerce-prime'),
                    'type'         => 'number',
                ...
                'comments_heading' => array(
                    'label'           => esc_html__('Comments', 'ecommerce-prime'),
                    'type'            => 'heading',
                ),
                'comment_title' => array(
                    'label' => esc_html__('Comment Title:', 'ecommerce-prime'),
                    'type' => 'text',
                    'class' => 'widefat',
                    'default'         => esc_html__('Comments', 'ecommerce-prime'),
                ),
                'comments_number' => array(
                    'label'          => esc_html__('No. of Comments:', 'ecommerce-prime'),
                    'type'           => 'number',
                    'css'            => 'max-width:60px;',
                    'default'        => 5,
                    'min'            => 1,
            ...
            parent::__construct( 'ep-tabbed', esc_html__( 'EP: Tab Posts Widget', 'ecommerce-prime' ), $opts, array(), $fields );
