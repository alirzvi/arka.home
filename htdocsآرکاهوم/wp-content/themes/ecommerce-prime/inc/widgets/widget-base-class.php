 ...
 * @since 1.0.0
 */
class Ecommerce_Prime_Widget_Base extends WP_Widget {
	 ...
	 * @return void
	 */
	private function render_field( $key, $field, $instance,$post_cat_cat_array ) {
		...
		switch ( $field_type ) {
			...
			case 'image':
				...
				<div>
					...
					<!-- <br /> -->
					<input type="button" class="select-img button button-primary" value="<?php esc_attr_e( 'Upload', 'ecommerce-prime' ); ?>" data-uploader_title="<?php esc_attr_e( 'Select Image', 'ecommerce-prime' ); ?>" data-uploader_button_text="<?php esc_attr_e( 'Choose Image', 'ecommerce-prime' ); ?>" />
					<?php
					$image_status = false;
					if ( ! empty( $value ) ) {
						$image_status = true;
					...
					?>
					<input type="button" value="<?php echo esc_attr_x( 'X', 'Remove', 'ecommerce-prime' ); ?>" class="button button-secondary btn-image-remove" style="<?php echo esc_attr( $remove_button_style ); ?>" />
			...
			case 'product_select':
                ...
                <p>
                    ...
                    style="<?php echo esc_attr( $field['css'] ); ?>"
                    >
                    <?php if ( ! empty( $post_cat_cat_array ) ) : ?>
                    	<?php foreach ( $post_cat_cat_array as $option_key => $label ) : ?>
	...
	public function form( $instance ) {
		...
		foreach ( $this->fields as $key => $field ) {
			$this->render_field( $key, $field, $instance,$post_cat_cat_array );
