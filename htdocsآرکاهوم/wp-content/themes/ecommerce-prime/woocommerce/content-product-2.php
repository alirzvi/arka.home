    ...
    <div class="individual-product-wrapper">
        ...
        <div class="twp-product-image-holder <?php if( $attachment_ids ){ echo "image-switch-enabled"; } ?>">
            ...
            <div class="twp-quicknav-items">
                ...
                <div class="twp-quicknav-item quicknav-item-cart" data-toggle="tooltip" data-placement="top" title="<?php esc_attr_e('Add To Cart','ecommerce-prime'); ?>">
                    <?php woocommerce_template_loop_add_to_cart(); ?>
                </div>

                <?php do_action('ecommerce_prime_add_to_wishlist_button'); ?>

                <?php do_action('ecommerce_prime_yith_quick_view_button'); ?>

                <?php do_action('ecommerce_prime_compare_button'); ?>
