	...
	if ( $font_name = get_option( 'hwp_font' ) ) {
		if ( $font_name == 'shabnam' ) {
			function hwp_theme_rtl() {
				wp_enqueue_style( 'shbnam-rtl', get_stylesheet_directory_uri() . '/rtl-shabnam.css', array(), false, 'all' );
			}
		} elseif ( $font_name == 'mitra' ) {
			function hwp_theme_rtl() {
				wp_enqueue_style( 'shbnam-rtl', get_stylesheet_directory_uri() . '/rtl-mitra.css', array(), false, 'all' );
			}
		}
	} else {
		function hwp_theme_rtl() {
