...
add_action( 'after_setup_theme', 'storeship_theme_setup', 10 );
function storeship_theme_setup() {
add_action('wp_enqueue_scripts', 'navid_rtl_css');	
}


function storeshipchild_translation_setup() {
	load_child_theme_textdomain( 'storeship', get_stylesheet_directory() . '/languages');
}
add_action( 'after_setup_theme', 'storeshipchild_translation_setup' );
