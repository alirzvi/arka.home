...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'فعال یا غیر فعالسازی فوتر', 'woodmart' ),
		'type'        => 'switcher',
		'default'     => '1',
		'priority'    => 10,
	)
...
Options::add_field(
	array(
		...
		'name'     => esc_html__( 'محتوای فوتر', 'woodmart' ),
		'type'     => 'buttons',
		'section'  => 'footer_section',
		'options'  => array(
			'widgets'    => array(
...
Options::add_field(
	array(
		...
		'group'       => esc_html__( 'آپشن های رنگ اسکیما', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'footer_section',
		'options'     => array(
			'dark'  => array(
...
Options::add_field(
	array(
		...
		'name'     => esc_html__( 'محتوای قبل فوتر', 'woodmart' ),
		'group'    => esc_html__( 'محتوای قبل فوتر', 'woodmart' ),
		'type'     => 'buttons',
		'section'  => 'footer_section',
		'options'  => array(
			'text'       => array(
