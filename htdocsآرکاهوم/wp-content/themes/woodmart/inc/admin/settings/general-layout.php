...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'شما میتوانید عرض چیدمان خودتان را بصورت پیکسلی مشخص نمایید ', 'woodmart' ),
		'type'        => 'select',
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'شما میتوانید حالت ساید بار موبایل را مخفی نمایید ', 'woodmart' ),
		'group'       => esc_html__( 'Sidebar', 'woodmart' ),
		'type'        => 'switcher',
		'default'     => '1',
		'priority'    => 50,
