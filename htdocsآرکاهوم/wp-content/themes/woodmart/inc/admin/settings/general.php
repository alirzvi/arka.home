...
Options::add_field(
	array(
		'id'       => 'page_comments',
		'name'     => esc_html__( 'نمایش دیدگاه ها در برگه', 'woodmart' ),
		'type'     => 'switcher',
		'section'  => 'general_section',
		'default'  => '1',
...
Options::add_field(
	array(
		'id'          => 'widget_title_tag',
		'name'        => esc_html__( 'تگ نمایش عنوان ها در ویجت', 'woodmart' ),
		'description' => esc_html__( 'انتخاب کنید نوع عنوان ویجت را از چه تگی باشد', 'woodmart' ),
		'type'        => 'select',
		'section'     => 'general_section',
		'default'     => 'h5',
		'options'     => array(
