...
Options::add_field(
	array(
		'id'          => 'page-title-size',
		'name'        => esc_html__( 'سایز عنوان برگه' ),
		'description' => esc_html__( '', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'page_title_section',
		'options'     => array(
			'default' => array(
...
Options::add_field(
	array(
		...
		'group'       => esc_html__( 'رنگ و بگ گراند', 'woodmart' ),
		'type'        => 'background',
		'default'     => array(
			'color'    => '#0a0a0a',
...
Options::add_field(
	array(
		...
		'group'       => esc_html__( 'آپشن های سئو و برودکرامپ', 'woodmart' ),
		'type'        => 'select',
		'section'     => 'page_title_section',
		'default'     => 'default',
		'options'     => array(
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'برای نصب افزونه Yoast SEO نیاز دارد. نان خرده‌های استاندارد WooCommerce را با نمونه سفارشی همراه با افزونه جایگزین می‌کند. شما باید آن را در داشبورد -> SEO -> ظاهر جستجو -> Breadcrumbs فعال و پیکربندی کنید.', 'woodmart' ),
		'group'       => esc_html__( 'Breadcrumbs & SEO options', 'woodmart' ),
		'type'        => 'switcher',
		'default'     => false,
		'priority'    => 70,
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'برای نصب افزونه Yoast SEO نیاز دارد. پودر سوخاری استاندارد را با نمونه سفارشی همراه با افزونه جایگزین می‌کند. شما باید آن را در داشبورد -> SEO -> ظاهر جستجو -> Breadcrumbs فعال و پیکربندی کنید.', 'woodmart' ),
		'group'       => esc_html__( 'Breadcrumbs & SEO options', 'woodmart' ),
		'type'        => 'switcher',
		'default'     => false,
		'priority'    => 80,
