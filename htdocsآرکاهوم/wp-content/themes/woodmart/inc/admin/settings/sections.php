...
Options::add_section(
	array(
		...
		'name'     => esc_html__( 'آرشیو وبلاگ', 'woodmart' ),
		'parent'   => 'blog_section',
		'priority' => 10,
		'icon'     => 'dashicons dashicons-admin-home',
	)
...
Options::add_section(
	array(
		...
		'name'     => esc_html__( 'تک مطلب', 'woodmart' ),
		'parent'   => 'blog_section',
		'priority' => 20,
		'icon'     => 'dashicons dashicons-admin-home',
	)
...
Options::add_section(
	array(
		...
		'name'     => esc_html__( 'آرشیو محصولات', 'woodmart' ),
		'priority' => 100,
...
Options::add_section(
	array(
		...
		'parent'   => 'product_archive_section',
		'name'     => esc_html__( 'استایل های دسته بندی', 'woodmart' ),
		'priority' => 30,
	)
);
...
Options::add_section(
	array(
		...
		'name'     => esc_html__( 'تک محصول', 'woodmart' ),
		'priority' => 110,
...
Options::add_section(
	array(
		...
		'parent'   => 'single_product_section',
		'name'     => esc_html__( 'افزودن به سبد خرید', 'woodmart' ),
		'priority' => 20,
	)
);
...
Options::add_section(
	array(
		...
		'name'     => esc_html__( 'اتصال ای پی آی', 'woodmart' ),
		'priority' => 140,
...
Options::add_section(
	array(
		'id'       => 'fonts_section',
		'name'     => esc_html__( 'فونت ها و آیکون ها', 'woodmart' ),
		'parent'   => 'performance',
		'priority' => 30,
	)
);
